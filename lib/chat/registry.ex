defmodule Chat.Registry do
  ...
  def start_link do
    ...
    # so we can reference it in other functions
  ...
  def handle_cast({:unregister_name, room_name}, state) do
    # Unregistering is as simple as deleting an entry from our map
  ...
  defp remove_pid(state, pid_to_remove) do
    # Here, we just filter out the dead pid
